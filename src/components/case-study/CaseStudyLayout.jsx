...
export default function CaseStudyLayout({
  project,
  children,
  navigationStickyEndId,
  navigationStickyStartId,
  navigationStickyStopId,
}) {
    ...
    >
      <div className="mx-auto grid max-w-[110rem] px-0 min-[1180px]:grid-cols-[clamp(10.625rem,15vw,13.75rem)_minmax(0,1fr)] min-[1180px]:gap-[clamp(1.75rem,2.5vw,2.5rem)] min-[1180px]:px-[clamp(1.5rem,2.5vw,2.5rem)]">
        <CaseStudyNavigation
          ...
          stickyEndId={navigationStickyEndId}
          stickyStartId={navigationStickyStartId}
          stickyStopId={navigationStickyStopId}
          project={project}
